...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 05 juil. 2023 à 14:07
...
(1, 1, 'images/timbre_animaux_1.jpg', 1, 'Image du timbre Animaux 1', 1),
(2, 1, 'images/timbre_animaux_1_back.jpg', 1, 'Image au dos du timbre Animaux 1', 2),
(3, 2, 'images/timbre_animaux_2.jpg', 1, 'Image du timbre Animaux 2', 1),
(4, 3, 'images/timbre_celebrites_1.jpg', 1, 'Image du timbre Célébrités 1', 1),
(5, 4, 'images/timbre_celebrites_2.jpg', 1, 'Image du timbre Célébrités 2', 1);
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `utilisateur_valide` tinyint(1) DEFAULT '0',
...
INSERT INTO `utilisateur` (`utilisateur_id`, `utilisateur_nom`, `utilisateur_prenom`, `utilisateur_adresse`, `utilisateur_courriel`, `utilisateur_mdp`, `utilisateur_DateInscription`, `utilisateur_valide`, `utilisateur_rating`) VALUES
(1, 'John Doe', '', '123 Rue de la Poste', 'john.doe@example.com', 'motdepasse1', '2022-01-01', 1, '4.5'),
(2, 'Jane Smith', '', '456 Avenue du Timbre', 'jane.smith@example.com', 'motdepasse2', '2022-02-01', 1, '4.2'),
(3, 'Robert Johnson', '', '789 Rue Principale', 'robert.johnson@example.com', 'motdepasse3', '2022-03-01', 1, '4.7'),
(4, 'Sarah Wilson', '', '987 Avenue des Philatélistes', 'sarah.wilson@example.com', 'motdepasse4', '2022-04-01', 1, '4.1'),
(5, 'Michael Brown', '', '654 Rue des Collectionneurs', 'michael.brown@example.com', 'motdepasse5', '2022-05-01', 1, '4.9');

INSERT INTO utilisateur  (`utilisateur_id`, `utilisateur_nom`, `utilisateur_prenom`,  `utilisateur_courriel`, `utilisateur_mdp`,  `utilisateur_renouveler_mdp`, `utilisateur_profil`) VALUES

(null, "administrateur", "Charles", "administrateur@gmail.com", SHA2("test", 512), "non", "administrateur"),
(null, "editeur", "Charles", "editeur@gmail.com", SHA2("test", 512), "non", "editeur"),
(null, "correcteur", "Charles", "correcteur@gmail.com", SHA2("test", 512), "non", "correcteur"),
(null, "client", "Charles", "basic@gmail.com", SHA2("test", 512), "non", "client");
