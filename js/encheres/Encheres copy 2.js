export default class EncheresApp {
  ...
  filterByFavoris(sType, items = this.#dataItems) {
    //return;
    console.log("filterByFavoris", this.#dataItems);
   ...
   * @param {Array} items - Tableau contenant les objects à afficher.
   */
  displayItemsOLS(items = this.#dataItems) {
   ...
   * @param {string} searchString - Chaîne de caractères à rechercher.
   */
  filterAndDisplayOLS(searchString = this.#searchString) {
    this.#searchString = searchString;
