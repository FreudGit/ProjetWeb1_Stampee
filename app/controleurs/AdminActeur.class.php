...
class AdminActeur extends Admin {
  ...
  protected $methodes = [
    ...
    'lf' => ['nom' => 'listerActeursFilm',   'droits' => [Utilisateur::PROFIL_ADMINISTRATEUR, Utilisateur::PROFIL_EDITEUR, Utilisateur::PROFIL_CORRECTEUR]],
    'mf' => ['nom' => 'modifierActeursFilm', 'droits' => [Utilisateur::PROFIL_ADMINISTRATEUR, Utilisateur::PROFIL_EDITEUR, Utilisateur::PROFIL_CORRECTEUR]]
  ];
   ...
   */
  public function listerActeursFilm() {
    $acteurs = $this->oRequetesSQL->getActeursFilm($this->film_id, true);
   ...
   * $this->acteur_id contient la liste des acteur_id à associer au film par ordre de priorité
   */
  public function modifierActeursFilm() {
    $acteurs = $this->oRequetesSQL->modifierActeursFilm($this->film_id, $this->acteur_id);
    echo json_encode($acteurs);
  }
}